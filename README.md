# react-startup
A template with webpack 4 + react 16 + react-router 4 setup for projects startup.
...
```
chare init dwqs/react-startup your-project-name -o remote-url-of-your-project
```
 ...
 * **state**: 状态管理工具选择，目前支持 mobx和 redux
